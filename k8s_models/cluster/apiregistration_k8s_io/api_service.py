...
from k8s_models.cluster.apiregistration.api_service_spec import APIServiceSpec
from k8s_models.cluster.apiregistration.api_service_status import APIServiceStatus
