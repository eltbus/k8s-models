...
class IPAddress(BaseModel):
    ...
    spec: IPAddressSpec = Field(
        default=None,
        description=r""" spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
...
class NetworkPolicy(BaseModel):
    ...
    spec: NetworkPolicySpec = Field(
        default=None,
        description=r""" spec represents the specification of the desired behavior for this NetworkPolicy. """,
    )
