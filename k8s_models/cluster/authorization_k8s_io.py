...
from k8s_models.definitions.unknown import SubjectAccessReviewStatus
...
class LocalSubjectAccessReview(BaseModel):
    ...
    spec: SubjectAccessReviewSpec = Field(
        default=None,
        description=r""" Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted. """,
    )
    status: SubjectAccessReviewStatus = Field(
        default=None,
        description=r""" Status is filled in by the server and indicates whether the request is allowed or not """,
    )
...
class SelfSubjectAccessReview(BaseModel):
    ...
    spec: SelfSubjectAccessReviewSpec = Field(
        default=None,
        description=r""" Spec holds information about the request being evaluated.  user and groups must be empty """,
    )
    status: SubjectAccessReviewStatus = Field(
        default=None,
        description=r""" Status is filled in by the server and indicates whether the request is allowed or not """,
...
class SelfSubjectRulesReview(BaseModel):
    ...
    status: SubjectRulesReviewStatus = Field(
        default=None,
        description=r""" Status is filled in by the server and indicates the set of actions a user can perform. """,
    )
