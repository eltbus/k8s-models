...
class ClusterRoleList(BaseModel):
    ...
    items: List[ClusterRole] = Field(
        default=None, description=r""" Items is a list of ClusterRoles """
    )
    kind: str = Field(
...
class ClusterRoleBindingList(BaseModel):
    ...
    items: List[ClusterRoleBinding] = Field(
        default=None, description=r""" Items is a list of ClusterRoleBindings """
    )
    kind: str = Field(
...
class RoleList(BaseModel):
    ...
    items: List[Role] = Field(
        default=None, description=r""" Items is a list of Roles """
    )
    kind: str = Field(
        default="RoleList",
        description=r""" Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds """,
...
class RoleBindingList(BaseModel):
    ...
    items: List[RoleBinding] = Field(
        default=None, description=r""" Items is a list of RoleBindings """
    )
    kind: str = Field(
