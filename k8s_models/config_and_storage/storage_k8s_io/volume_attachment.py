...
from k8s_models.config_and_storage.storage.volume_attachment_spec import VolumeAttachmentSpec
from k8s_models.config_and_storage.storage.volume_attachment_status import VolumeAttachmentStatus
