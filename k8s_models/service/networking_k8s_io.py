...
class ClusterCIDR(BaseModel):
    ...
    spec: ClusterCIDRSpec = Field(
        default=None,
        description=r""" spec is the desired state of the ClusterCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
...
class Ingress(BaseModel):
    ...
    spec: IngressSpec = Field(
        default=None,
        description=r""" spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
    status: IngressStatus = Field(
        default=None,
        description=r""" status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
...
class IngressClass(BaseModel):
    ...
    spec: IngressClassSpec = Field(
        default=None,
        description=r""" spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
