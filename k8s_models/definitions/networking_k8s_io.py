...
class IPBlock(BaseModel):
    ...
    besides: List[str] = Field(default=None, description=r""" except is a slice of CIDRs that should not be included within an IPBlock Valid examples are "192.168.1.0/24" or "2001:db8::/64" Except values will be rejected if they are outside the cidr range """, alias="except")
