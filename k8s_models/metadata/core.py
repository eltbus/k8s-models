...
class LimitRange(BaseModel):
    ...
    spec: LimitRangeSpec = Field(
        default=None,
        description=r""" Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
...
class LimitRangeSpec(BaseModel):
    limits: List[LimitRangeItem] = Field(
        default=None,
        description=r""" Limits is the list of LimitRangeItem objects that are enforced. """,
    )
...
class PodTemplate(BaseModel):
    ...
    template: PodTemplateSpec = Field(
        default=None,
        description=r""" Template defines the pods that will be created from this pod template. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status """,
    )
