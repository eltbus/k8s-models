...
class ControllerRevision(BaseModel):
    ...
    data: Any = Field(
        default=None,
        description=r""" Data is the serialized representation of the state. """,
    )
    kind: str = Field(
    ...
    revision: int = Field(
        default=None,
        description=r""" Revision indicates the revision of the state represented by Data. """,
    )
...
class ControllerRevisionList(BaseModel):
    ...
    items: List[ControllerRevision] = Field(
        default=None, description=r""" Items is the list of ControllerRevisions """
    )
    kind: str = Field(
