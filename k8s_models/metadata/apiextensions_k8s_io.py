...
from k8s_models.metadata.apiextensions import CustomResourceDefinitionSpec
from k8s_models.definitions.unknown import CustomResourceDefinitionStatus
...
class CustomResourceDefinition(BaseModel):
    ...
    spec: CustomResourceDefinitionSpec = Field(
        default=None,
        description=r""" spec describes how the user wants the resources to appear """,
    )
    status: CustomResourceDefinitionStatus = Field(
        default=None,
        description=r""" status indicates the actual state of the CustomResourceDefinition """,
    )
