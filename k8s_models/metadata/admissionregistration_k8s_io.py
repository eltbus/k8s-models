...
from k8s_models.definitions.admissionregistration_k8s_io import MutatingWebhook, ValidatingWebhook
from k8s_models.metadata.admissionregistration import ValidatingAdmissionPolicySpec, ValidatingAdmissionPolicyBindingSpec
