...
from k8s_models.metadata.resource import PodSchedulingContextSpec, ResourceClaimSpec, ResourceClaimTemplateSpec
from k8s_models.definitions.unknown import PodSchedulingContextStatus, ResourceClaimStatus
